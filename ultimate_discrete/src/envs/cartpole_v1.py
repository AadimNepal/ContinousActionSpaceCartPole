...
class CartpoleEnvV1(gym.Env):
    ...
    def __init__(self, env_context=None, render_mode=None):
        ...
        self.isopen = True
        self.state = None
        self.previous_state = np.array([0.0,0.0,0.0,0.0])
    ...
    def _process_state(self):
        ...
        # providing previous and current state information without accelerations
        processed_state = np.array([self.state[0], self.previous_state[0],self.state[2], self.previous_state[2]], dtype = np.float32)

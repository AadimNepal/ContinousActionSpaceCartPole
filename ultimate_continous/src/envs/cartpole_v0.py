...
class CartpoleEnvV0(gym.Env):
    ...
    def __init__(self, env_context=None, render_mode=None):
        ...
        #Action space is now continous in the range -1 to 1
    ...
    def step(self, action):
        ...
        force = self.force_mag * action # since action space is continous, force is magnitude times action, its not discrete anymore
